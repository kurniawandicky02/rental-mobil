							...
							<div class="col">
								<div class="p-5">
									<div class="text-center">
										<img class="gambar" src="uploads/adm.jpg">
									...
									<form class="user" method="POST" action="<?= base_url('auth/login') ?>">
										<div class="form-group">
											<input type="text" class="form-control form-control-user" name="username" placeholder="username : dicky" autocomplete="off" required="required" autofocus>
										</div>
										<div class="form-group">
